            ...
            with gr.Accordion("Ranbooru", open=False):
                ...
                with gr.Group():
                    with gr.Accordion("File", open=False):
                        ...
                        choose_search_txt = gr.Dropdown(self.get_files('scripts/ranbooru/search'),
                                                        label="Choose tags_search.txt", value="")
                        use_remove_txt = gr.Checkbox(label="Use tags_remove.txt", value=False)
                        choose_remove_txt = gr.Dropdown(self.get_files('scripts/ranbooru/remove'),
                                                        label="Choose tags_remove.txt", value="")
                with gr.Group():
